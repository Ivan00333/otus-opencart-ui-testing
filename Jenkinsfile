pipeline {
  ...
  parameters {
    string(name: 'SELENOID_URL', defaultValue: 'http://localhost:4444/wd/hub', description: 'URL Selenoid')
    string(name: 'BASE_URL',     defaultValue: 'http://localhost',         description: 'Адрес Opencart')
