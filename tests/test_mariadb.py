...
class TestDb:
    ...
    def test_update_user(self, connection):
        db = Db(connection, "test_update_user")
    ...
    def test_negative_update_user(self, connection):
        db = Db(connection, "test_negative_update_user")
    ...
    def test_delete_user(self, connection):
        db = Db(connection, "test_delete_user")
